...
angular.module('starter.controllers', ['ionic.cloud'])
    ...
    .controller('versionsCtrl', function($scope, BlankService, $ionicPush, $http) {
        $scope.service = BlankService;
            ...
            if (actuacion != undefined) {
                if (actuacion.nameAlarm != undefined) {
                    if (actuacion.alarmId != "0") {
                        ...
                        $scope.asignoAlarmaInSystem(timeAlarm, idAlarmaInSystem, actuacion.id, text)
    ...
    .controller('detailTreatmentCtrl', function($scope, $ionicPopup, $timeout, BlankService, $window, $state, $ionicPlatform, $cordovaInAppBrowser) {
